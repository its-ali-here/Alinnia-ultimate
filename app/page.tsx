          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {[
                {
                  quote:
                    "Alinnia has transformed how we manage our projects. The automation features have saved us countless hours of manual work.",
                ...
                {
                  quote:
                    "We've tried several similar solutions, but none compare to the ease of use and comprehensive features of Alinnia. It's been a game-changer.",
                  author: "David Kim",
                        ...
                        >
                          ...
                          <CardContent className="p-6 flex flex-col h-full">
                            ...
                            <Link href="/auth/signup">
                              ...
                              >
                                {plan.cta === "Start Free Trial" ? "Start Free Trial" : plan.cta}
                              </Button>
                            </Link>
                          </CardContent>
                        </Card>
