...
export function Dropdown({ options, value, onChange, style }: DropdownProps) {
...
function getStyles(colors: ThemeColors) {
  return StyleSheet.create({
    ...
    triggerText: { fontSize: fontSize.md, fontFamily: fontFamily.body, color: colors.text },
    backdrop: { flex: 1, backgroundColor: "rgba(0,0,0,0.6)", alignItems: "center", justifyContent: "center" },
    card: { backgroundColor: colors.surface, borderRadius: radius.lg, overflow: "hidden", width: 220, maxHeight: 360 },
    option: { paddingVertical: spacing.md, paddingHorizontal: spacing.lg, borderBottomWidth: 1, borderBottomColor: colors.border },
    optionText: { fontSize: fontSize.md, fontFamily: fontFamily.bodyMedium, color: colors.text, textAlign: "center" },
